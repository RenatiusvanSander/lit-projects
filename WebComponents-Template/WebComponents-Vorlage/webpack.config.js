...
const defaultEnv = {
  ...
  iconPathCominvest: '/assets/svg/svg-symbol.svg'
};
...
const webComponentsES6 = (mode, { iconPath, iconPathCominvest, theme = '' }) => ({
  entry: [
  ...
  plugins: [
    ...
    new DefinePlugin({
      ...
      ICON_PATH_COMINVEST: JSON.stringify(iconPathCominvest)
    }),
    new IgnorePlugin({
...
const webComponentsES5 = (mode, { iconPath, iconPathCominvest, theme = '' }) => ({
  entry: [
