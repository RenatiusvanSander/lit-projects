...
var NameTag = function () {
    var _classDecorators = [(0, decorators_js_1.customElement)('name-tag')];
    ...
    var NameTag = _classThis = /** @class */ (function (_super) {
        __extends(NameTag_1, _super);
        function NameTag_1() {
        ...
        NameTag_1.prototype.render = function () {
            return (0, lit_1.html)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Hello I'm ", "."], ["Hello I'm ", "."])), this.name);
        };
        return NameTag_1;
    }(_classSuper));
    __setFunctionName(_classThis, "NameTag");
    (function () {
        var _a;
        ...
        NameTag = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NameTag = _classThis;
}();
